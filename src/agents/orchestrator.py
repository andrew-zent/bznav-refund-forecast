...
PIPELINE_STEPS = [
    ...
    {
        "name": "utm_channel_analysis",
        "script": "utm_channel_analysis.py",
        "description": "UTM 채널 효율 분석",
        "error_policy": ErrorPolicy.SKIP,
        "max_retries": 0,
    },
    {
        "name": "channel_deep_analysis",
        "script": "channel_deep_analysis.py",
        "description": "채널 정밀 분석 (신규/리마인드, 캠페인 A/B, 멀티터치)",
        "error_policy": ErrorPolicy.SKIP,
        "max_retries": 0,
    },
    {
        "name": "attribution_analysis",
        "script": "attribution_analysis.py",
        "description": "First/Last/Linear 어트리뷰션 + CRM Lift + Journey Matrix",
        "error_policy": ErrorPolicy.SKIP,
        "max_retries": 0,
    },
    {
        "name": "channel_funnel_analysis",
        "script": "channel_funnel_analysis.py",
        "description": "채널별 퍼널 전환율 + 분기 트렌드 + 자력전환율",
        "error_policy": ErrorPolicy.SKIP,
        "max_retries": 0,
    },
    {
